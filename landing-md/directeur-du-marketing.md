...
```text
{
  ...
  "summary": "Antoine Blot, Directeur marketing externe au Québec, structure votre stratégie de croissance via un pilotage ROIste et une architecture marketing data-driven.",
  "tags": [
...
- **Compétence** : Stratégie et planification
- **Description** : Création de plans marketing annuels et alignement sur vos objectifs de vente.

- **Compétence** : Acquisition et performance
- **Description** : Pilotage du SEO, SEA et des campagnes payantes pour générer des leads qualifiés.

- **Compétence** : Identité de marque
- **Description** : Développement d'un positionnement clair et d'un message qui résonne au Québec.

- **Compétence** : Analyse et optimisation
- **Description** :  Suivi rigoureux des données pour ajuster les actions et maximiser le ROI.

- **Compétence** : Gestion de projets
- **Description** :  Orchestration des ressources et des échéanciers pour une exécution sans faille.
