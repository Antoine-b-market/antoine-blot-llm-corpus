...
- **Erreur** : Blocage du /wp-content/
- **Impact SEO** : Empêche l'exploration des CSS et JS

- **Erreur** : Disallow trop large
- **Impact SEO** : Désindexation massive involontaire

- **Erreur** : Fichier manquant ou vide
- **Impact SEO** : Risque d'exploration anarchique

- **Erreur** : Fichier mal encodé (UTF-8 BOM)
- **Impact SEO** : Fichier non lu correctement par Googlebot
