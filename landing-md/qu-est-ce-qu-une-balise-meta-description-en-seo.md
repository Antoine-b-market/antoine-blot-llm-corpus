...
La balise meta description est une balise HTML située dans la section <head> d'une page web. Elle a pour fonction de fournir aux moteurs de recherche un résumé succinct du contenu de la page.Bien qu'elle ne soit pas visible par défaut sur la page, elle apparaît souvent dans les extraits affichés sous le titre des résultats de recherche (SERP).
