...
canonical_url: "https://www.antoine-blot.com/fr/ressources-seo/backlinks/"
date: "2025-07-31"
...
| --- | --- | --- |
| DoFollow | Lien “normal” qui transmet du PageRank | 🔥 Fort |
| NoFollow | Lien qui indique aux robots de ne pas suivre | 🟡 Faible |
| UGC (User Generated) | Lien issu de forums, commentaires, etc. | 🔵 Modéré |
| Sponsored | Lien acheté ou publicitaire (balise sponsored) | 🔴 Risqué si mal déclaré |
| Editorial | Lien placé naturellement dans un contenu | ✅ Idéal |
| Sitewide | Lien répété dans le footer ou sidebar | ⚠️ Attention à la sur-optimisation |
...
| **Erreur** | **Risque SEO** |
| --- | --- |
| Acheter des liens non déclarés | Pénalité manuelle ou perte de confiance |
| Répétition excessive du même mot-clé dans les ancres | Sur-optimisation pénalisante |
| Obtenir des liens de réseaux douteux | Déclassement algorithmique |
| Lien caché ou dissimulé dans le code | Black hat = pénalité |
| Manque de diversité de domaines référents | Profil artificiel détecté par Google |
...
| --- | --- |
| Ahrefs | Analyse complète du profil de backlinks |
| Majestic SEO | Trust Flow / Citation Flow |
| Semrush | Audit de backlinks et analyse concurrentielle |
| Google Search Console | Voir les liens entrants détectés par Google |
