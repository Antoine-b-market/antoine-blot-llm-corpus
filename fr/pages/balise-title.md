...
canonical_url: "https://www.antoine-blot.com/fr/ressources-seo/balise-title/"
date: "2025-07-31"
...
La **balise title** (ou « titre de page ») est une balise HTML située dans l’en-tête (<head>) d’une page web. Elle a pour fonction de **définir le titre de cette page**, tel qu’il sera affiché dans :
...
1. 1. **Un facteur de classement fondamental**
...
1. 2. **Un impact direct sur le taux de clic (CTR)**
...
1. 3. **Un levier stratégique facile à actionner**
...
La balise title est insérée dans le code HTML de chaque page, entre les balises <head> et </head>. Par exemple :
...
<html lang="fr">
<head>
  <title>Qu’est-ce qu’une balise title en SEO ? | Antoine Blot</title>
</head>
<body>
...
| --- | --- |
| ❌ Même title sur plusieurs pages | Contenu dupliqué, confusion pour les moteurs |
| ❌ Title trop générique (ex : “Accueil”) | Manque de pertinence, CTR très faible |
| ❌ Absence de mot-clé | Non-pertinence, perte de valeur sémantique |
| ❌ Title trop long (> 70 caractères) | Troncature dans les SERP, message incomplet |
| ❌ Title clickbait non aligné au contenu | Mauvais taux de rebond, désindexation possible |
...
| **Screaming Frog SEO Spider** | Analyser tous les titles du site en masse |
...
| Marque ou nom de domaine | ✅ Optionnel | En fin de title, utile pour branding |
| Longueur < 65 caractères | ✅ Oui | Pour éviter la troncature dans Google |
| Formulation unique | ✅ Oui | Ne jamais dupliquer un title d’une autre page |
| Ton engageant mais sobre | ✅ Oui | Éviter le clickbait, rester crédible |
