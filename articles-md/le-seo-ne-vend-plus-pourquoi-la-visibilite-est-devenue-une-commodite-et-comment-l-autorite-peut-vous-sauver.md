...
| Dimension | Contenu classique (informationnel) | Actif cognitif (connaissance) | 
| --- | --- | --- |
| Rôle principal | Explique un concept connu | Décide d'une direction | 
| Positionnement | Résume l'existant | Prend position et clive | 
| Relation à l'utilisateur | Répond à une requête | Modifie le cadre mental | 
| Logique d'optimisation | Optimisé pour le clic | Optimisé pour la citation par l'IA | 
